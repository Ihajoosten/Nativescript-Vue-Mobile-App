...
module.exports = {
    getAllWorkedHours: async (req, res, next) => {
        ...
        const query = `select wh.Id, wh.Branch_DepartmentId, wh.Date, wh.StartTime, wh.EndTime, wh.UserId, bp.BranchId, bp.DepartmentId, b.Name as BranchName, d.Name as DepartmentName
    ...
    getLast5WorkedHours: async (req, res, next) => {
        const userId = req.userid;
        const query =
            `select wh.Id, wh.Branch_DepartmentId, wh.Date, wh.StartTime, wh.EndTime, wh.UserId, bp.BranchId, bp.DepartmentId, b.Name as BranchName, d.Name as DepartmentName
            from Worked_hours as wh
            JOIN Branch_Department as bp on bp.Id = wh.Branch_DepartmentId
            JOIN Branch as b on b.Id = bp.BranchId
            JOIN Department as d on d.Id = bp.DepartmentId
